  ...
  return (
    <div className="Left-Header-container">
      <img
        ...
        src="https://res.cloudinary.com/dgviahrbs/image/upload/v1696864054/WhatsApp_Image_2023-09-23_at_6.26.43_PM_ypoax7-Profile.jpg_suhp4h.png"
        alt="Profile"
      />
      <h1 className="profile-name">Kasiralla Praveen </h1>
      ...
      <div className="contact-card">
        ...
        <div className="group-card">
          <div>
            <img
              src="https://res.cloudinary.com/dgviahrbs/image/upload/v1696924822/Vector_3_ysp7ie.svg"
              alt="email"
            />
          </div>
          <div className="group-items">
            <p className="item-heading">Email</p>
            <p> Praveenpandu3039@gmail.com</p>
          </div>
        </div>
        <hr className="line" />
        <div className="group-card">
          <div>
            <img
              src="https://res.cloudinary.com/dgviahrbs/image/upload/v1696924817/Vector_4_hsfxrd.svg"
              alt="location"
            />
          </div>
          <div className="group-items">
        ...
        <button className="download-resume">
          {" "}
          <a
            href="https://s3-ap-south-1.amazonaws.com/nkb-backend-ccbp-media-static/ccbp_prod/media/resume_generated/Praveen_Kumar_2023-10-13-121448.pdf"
            target="__blank"
          >
            {" "}
            Download Resume{" "}
